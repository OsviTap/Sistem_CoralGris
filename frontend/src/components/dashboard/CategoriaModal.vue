                ...
                <form @submit.prevent="handleSubmit" class="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      placeholder="Ej: Libros, Material Escolar, Oficina"
                    />
                  </div>
...
const handleSubmit = async () => {
  ...
  try {
    if (isEditing.value) {
      await categoriaStore.updateCategoria(props.categoria.id, formData.value)
    } else {
      await categoriaStore.createCategoria(formData.value)
    }
